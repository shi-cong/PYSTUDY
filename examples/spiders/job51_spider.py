...
class Job51Spider:
    ...
    def search(self, keyword, requestCookie, page=1):
        ...
        while n < len(jobsIdHtml):
            ...
            add_job(jobId, job_name, company, addr, money, date)
...
前程无忧爬虫
"""
from examples.mysqllib_demos.job51_db import *
from shicong.html_parserlib import XpathParser, ReParser
from shicong.randomlib import random_small_number
...
class Job51Spider:
    ...
    def submitJob(self, jobId, referer, requestCookie):
        ...
        p = 'rand=' + str(
            random_small_number()) + '&jsoncallback=jQuery18302138634134253048_1507066246973&jobid=(' + str(
